...
export type NodeRelation = {
  ...
  backendName?: string;
  backendOpts?: BackendOptions;
  loaderKeys: NodeRelationLoaderKey[];
  filters?: NodeRelationFilter[];
};

export type NodeRelationLoaderKey = {
  node: string;
  prop: string;
  backendOpts?: BackendOptions;
};
...
export type NodeDefinitionP = {
  ...
  properties: NodePropertyP[];
  relations?: NodeRelationP[];
};

export type NodeCanonicalP = {
  name: string;
  backendName: string;
  backendOpts: BackendOptions;
};

export type NodePropertyP = {
  name: string;
  vanity: boolean;
  backendName: string;
  backendOpts: BackendOptions;
...
export type NodeRelationP = {
  name: string;
  backendName: string;
  backendOpts: BackendOptions;
  loaderKeys: NodeRelationLoaderKeyP[];
  filters?: NodeRelationFilter[];
};

export type NodeRelationLoaderKeyP = {
  node: string;
  prop: string;
  backendOpts: BackendOptions;
};

export type NodeRelationFilterP = {
  node: string;
  prop: string;
  predicate: string;
  value: string;
...
interface INodeDefinitionRegistry {
  lookup   (name: string): NodeDefinitionP | void;
  register (def: NodeDefinitionP): void;
  getAll   (): { [string]: NodeDefinitionP };
  wipe     (): void;
};

const NodeDefinitionRegistry: INodeDefinitionRegistry = {
  _registry: new Map(),
  lookup (name: string): NodeDefinitionP | void {
